...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<AccessToken> CreateAccessToken(User user)
        {
            ...
            return new SuccesDataResult<AccessToken>(accessToken, UserMessages.AccessTokenCreated);
        }
        ...
        public IDataResult<User> Login(UserForLoginDto userForLoginDto)
        {
            ...
            return new SuccesDataResult<User>(userToCheck, UserMessages.SuccesfulLogin);
        }
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegisterDto, string password)
        {
            ...
            return new SuccesDataResult<User>(user, UserMessages.UserRegistered);
        }
